		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
			    <ul class="navbar-nav flex-glow-1">
			    		<li class="nav-item">
					    	<a class="nav-link <%=thisPage.equals("food") ? "active":"" %>" href="${pageContext.request.contextPath }/food/list.jsp">food</a>
						</li>
			    </ul>
			    <div class="w-100 clearfix">
			       <a class="btn btn-warning btn-sm float-end ms-1" href="#">회원가입</a>
